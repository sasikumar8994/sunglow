class ContactFormsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @contact_form.save
        ContactFormMailer.cf_notify_admin(@contact_form).deliver_now
        format.html { redirect_to @contact_form, notice: 'Contact u was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @contact_form.update(contact_form_params)
        format.html { redirect_to @contact_form, notice: 'Contact u was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to contact_forms_url, notice: 'Contact u was successfully destroyed.' }
  ...
  private
    ...
    def contact_form_params
      params.require(:contact_form).permit(:hours_of_operation, :number_of_fixtures, :company, :first_name, :last_name, :email, :phone)
    end
end
